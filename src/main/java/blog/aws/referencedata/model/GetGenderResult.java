...
public class GetGenderResult extends com.amazonaws.opensdk.BaseResult implements Serializable, Cloneable {
    ...
    public GetGenderResult empty(Empty empty) {
        setEmpty(empty);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetGenderResult == false)
            return false;
        GetGenderResult other = (GetGenderResult) obj;
    ...
    @Override
    public GetGenderResult clone() {
        try {
            return (GetGenderResult) super.clone();

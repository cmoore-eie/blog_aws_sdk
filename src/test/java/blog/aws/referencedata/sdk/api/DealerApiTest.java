...
import blog.aws.referencedata.sdk.builders.DealerBuilder;
import blog.aws.referencedata.sdk.builders.DealerLocationBuilder;
import blog.aws.referencedata.sdk.model.Dealer;
import blog.aws.referencedata.sdk.model.DealerDealerLocations;
import blog.aws.referencedata.sdk.util.ClientUtil;
...
/*        Dealer response = api.dealerPost(dealer_data);
...
/*    private List<Dealer> findDealer(String inIdentifier){
    ...
    private DealerDealerLocations findLocationForName(Dealer inDealer, String inCheckItem){

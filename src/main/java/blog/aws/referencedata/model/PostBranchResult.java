...
public class PostBranchResult extends com.amazonaws.opensdk.BaseResult implements Serializable, Cloneable {
    ...
    public PostBranchResult empty(Empty empty) {
        setEmpty(empty);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PostBranchResult == false)
            return false;
        PostBranchResult other = (PostBranchResult) obj;
    ...
    @Override
    public PostBranchResult clone() {
        try {
            return (PostBranchResult) super.clone();

...
public class PutBranchResult extends com.amazonaws.opensdk.BaseResult implements Serializable, Cloneable {
    ...
    public PutBranchResult empty(Empty empty) {
        setEmpty(empty);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutBranchResult == false)
            return false;
        PutBranchResult other = (PutBranchResult) obj;
    ...
    @Override
    public PutBranchResult clone() {
        try {
            return (PutBranchResult) super.clone();

...
public class PutGenderResult extends com.amazonaws.opensdk.BaseResult implements Serializable, Cloneable {
    ...
    public PutGenderResult empty(Empty empty) {
        setEmpty(empty);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutGenderResult == false)
            return false;
        PutGenderResult other = (PutGenderResult) obj;
    ...
    @Override
    public PutGenderResult clone() {
        try {
            return (PutGenderResult) super.clone();

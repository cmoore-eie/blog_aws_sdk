...
public class DeleteGenderResult extends com.amazonaws.opensdk.BaseResult implements Serializable, Cloneable {
    ...
    public DeleteGenderResult empty(Empty empty) {
        setEmpty(empty);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteGenderResult == false)
            return false;
        DeleteGenderResult other = (DeleteGenderResult) obj;
    ...
    @Override
    public DeleteGenderResult clone() {
        try {
            return (DeleteGenderResult) super.clone();

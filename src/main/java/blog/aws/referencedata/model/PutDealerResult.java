...
public class PutDealerResult extends com.amazonaws.opensdk.BaseResult implements Serializable, Cloneable {
    ...
    public PutDealerResult empty(Empty empty) {
        setEmpty(empty);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutDealerResult == false)
            return false;
        PutDealerResult other = (PutDealerResult) obj;
    ...
    @Override
    public PutDealerResult clone() {
        try {
            return (PutDealerResult) super.clone();

...
public class DeleteDealerResult extends com.amazonaws.opensdk.BaseResult implements Serializable, Cloneable {
    ...
    public DeleteDealerResult empty(Empty empty) {
        setEmpty(empty);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteDealerResult == false)
            return false;
        DeleteDealerResult other = (DeleteDealerResult) obj;
    ...
    @Override
    public DeleteDealerResult clone() {
        try {
            return (DeleteDealerResult) super.clone();
